...
🔭 Building small web projects using **React, Tailwind, and Node.js**  
🌱 Learning **TypeScript** (basic)  
👯 Open to beginner-friendly collaborations  
🤔 Improving coding skills & best practices  
⚡ Fun fact: I come from a **multimedia design** background  
🎯 Goal: Build practical **web projects** while improving skills
